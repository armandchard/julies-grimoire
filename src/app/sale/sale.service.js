(function () {
  ...
  saleService.$inject = ['$q', '$filter', '$http', 'CONSTS', 'listService', 'authService', 'firebaseDataService', 'productService'];

  function saleService($q, $filter, $http, CONSTS, listService, authService, firebaseDataService, productService) {
    var userProducts = [];
