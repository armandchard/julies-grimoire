(function () {
  ...
  NavbarController.$inject = ['$http', 'CONSTS', '$state', 'authService', 'firebaseDataService', '$firebaseArray'];

  function NavbarController($http, CONSTS, $state, authService, firebaseDataService, $firebaseArray) {
    var vm = this;
